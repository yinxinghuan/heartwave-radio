...
export default function V2Artwork({broadcast,world}:{broadcast:Broadcast;world:ArtWorld}){
  const channel=CHANNELS[broadcast.channel],title=broadcast.title||channel.name,line=broadcast.line||channel.line;
  return <article className={`v2-art v2-art--${world} v2-art--${broadcast.channel}`}>
