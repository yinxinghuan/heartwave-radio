...
export interface Broadcast { id: string; createdAt: number; channel: Dimension; frequency: string; score: number; tags: string[]; picks: string[]; }
export interface HeartwaveSave { broadcasts: Broadcast[]; }
